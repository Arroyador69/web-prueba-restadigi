...
export const en: Messages = {
  ...
  widget: {
    sales: {
      ...
      demoHint: "",
      demoSubtitle: "Resta-AI",
    },
    booking: {
      openLabel: "Book a table",
      closeLabel: "Close",
      openAria: "Open Resta-AI booking demo",
      closeAria: "Close chat",
      dialogAria: "Resta-AI table booking demo",
      eyebrow: "RESTADIGI",
      title: "Resta-AI",
      welcome:
        "Hi! I’m Resta-AI — the demo bot for table reservations. I’ll show how the bot helps guests at a restaurant. Share your name, party size, date, time (12:00–22:00) and phone. Email is optional.\n\nDemo: nothing is saved. I’m an AI assistant and I’m learning all the time!",
      ...
      quickReplies: [
        {
          label: "2 guests tomorrow",
          message:
            "I’d like a table for 2 tomorrow at 19:00. My name is Anna Virtanen, phone +358401111111.",
        },
        {
          label: "4 guests Friday",
          message: "Book for 4 on Friday at 20:00. My name is Mikko, phone +358402222222.",
        },
        { label: "Opening hours?", message: "When is the restaurant open and when can I book?" },
        { label: "Start booking", message: "I’d like to book a table. How do we proceed?" },
      ],
      demoEyebrow: "RESTADIGI",
      demoOpenLabel: "Try the bot",
      demoHint:
        "Try a booking like a real guest. The bot asks for details and confirms — nothing is saved in this demo.",
      demoSubtitle: "Demo · table booking",
    },
  },
};
