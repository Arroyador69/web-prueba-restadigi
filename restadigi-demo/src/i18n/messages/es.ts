...
export const es: Messages = {
  ...
  widget: {
    ...
    booking: {
      ...
      closeLabel: "Cerrar",
      openAria: "Abrir demo Resta-AI de reservas",
      closeAria: "Cerrar chat",
      dialogAria: "Resta-AI demo de reservas de mesa",
      eyebrow: "RESTADIGI",
      title: "Resta-AI",
      welcome:
        "¡Hola! Soy Resta-AI — el bot demo de reservas de mesa. Te muestro cómo atiende al cliente en un restaurante. Indica nombre, personas, fecha, hora (12:00–22:00) y teléfono. El correo es opcional.\n\nDemo: no se guarda nada. Soy un asistente de inteligencia artificial y aprendo continuamente.",
      placeholder: "Escribe tu pregunta aquí…",
      sendAria: "Enviar mensaje",
      resetAria: "Reiniciar conversación",
      typing: "Escribiendo…",
      ...
      quickReplies: [
        {
          label: "2 personas mañana",
          message:
            "Quiero reservar mesa para 2 mañana a las 19:00. Me llamo Anna Virtanen, tel +358401111111.",
        },
        {
          label: "4 el viernes",
          message: "Reserva para 4 el viernes a las 20:00. Me llamo Mikko, tel +358402222222.",
        },
        { label: "¿Horarios?", message: "¿A qué hora abrís y cuándo se puede reservar?" },
        { label: "Empezar reserva", message: "Quiero reservar una mesa. ¿Cómo lo hacemos?" },
      ],
      demoEyebrow: "RESTADIGI",
      demoOpenLabel: "Probar el bot",
      demoHint:
        "Prueba una reserva como haría un cliente. El bot pide los datos y confirma — en esta demo no se guarda nada.",
      demoSubtitle: "Demo · reservas de mesa",
    },
  },
};
