...
export const fi: Messages = {
  ...
  widget: {
    ...
    booking: {
      ...
      closeLabel: "Sulje",
      openAria: "Avaa Resta-AI pöytävarausdemo",
      closeAria: "Sulje chat",
      dialogAria: "Resta-AI pöytävarausdemo",
      eyebrow: "RESTADIGI",
      title: "Resta-AI",
      welcome:
        "Hei! Olen Resta-AI — demobotti pöytävarauksiin. Näytän miten botti palvelee asiakasta ravintolassa. Kerro nimesi, henkilömäärä, päivä, kellonaika (12–22) ja puhelinnumero. Sähköposti on vapaaehtoinen.\n\nDemo: tietoja ei tallenneta. Olen tekoälyavustaja ja opin koko ajan uutta!",
      ...
      quickReplies: [
        {
          label: "2 hlö huomenna",
          message: "Haluan varata pöydän kahdelle huomenna klo 19. Nimeni on Anna Virtanen, puh +358401111111.",
        },
        {
          label: "4 hlö perjantaina",
          message: "Varaa neljälle perjantaina klo 20. Nimeni on Mikko, puh +358402222222.",
        },
        { label: "Aukioloajat?", message: "Milloin ravintola on auki ja milloin voi varata?" },
        { label: "Aloita varaus", message: "Haluaisin varata pöydän. Miten etenemme?" },
      ],
      demoEyebrow: "RESTADIGI",
      demoOpenLabel: "Kokeile bottia",
      demoHint:
        "Kokeile varausta kuten asiakas. Botti kysyy tiedot ja vahvistaa — demossa mitään ei tallenneta.",
      demoSubtitle: "Demo · pöytävaraus",
    },
  },
};
