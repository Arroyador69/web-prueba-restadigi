...
(function (global) {
  ...
  var DICT = {
    es: {
      ...
      online: 'Online',
      msg_ok_marker: 'ok',
      msg_patient_updated: 'Paciente actualizado correctamente',
      msg_patient_created: 'Paciente creado correctamente',
      ...
      msg_delete_patient_confirm: '¿Eliminar al paciente "{name}"? Se eliminarán también sus datos. Esta acción no se puede deshacer.',
      msg_delete_patient_error: 'Error eliminando paciente',
    ...
    en: {
      ...
      msg_delete_patient_confirm: 'Delete patient "{name}"? Their data will also be removed. This cannot be undone.',
      msg_delete_patient_error: 'Error deleting patient',
